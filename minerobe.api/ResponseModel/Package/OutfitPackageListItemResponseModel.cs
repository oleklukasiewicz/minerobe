...
namespace minerobe.api.ResponseModel.Package
{
    ...
    {
        public static OutfitPackageListItemResponseModel ToListItemResponseModel(this OutfitPackage entity, int layersCount = 2, bool isInWardrobe = false)
        {
            ...
            else
            {
                ...
                if (entity.Layers?.Count > 0)
                {
                    ...
                    {
                        layers.Add(entity.Layers[i].ToResponseModel(entity, true));
                    }
                }
            }
        ...
        public static List<OutfitPackageListItemResponseModel> ToListItemResponseModel(this List<OutfitPackage> entity, int layersCount = 2)
        {
