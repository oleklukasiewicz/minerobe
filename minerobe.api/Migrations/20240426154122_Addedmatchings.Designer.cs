...
namespace minerobe.api.Migrations
{
    ...
    [Migration("20240426154122_Addedmatchings")]
    partial class Addedmatchings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("minerobe.api.Entity.Package.OutfitLayer", b =>
                {
                    b.HasOne("minerobe.api.Entity.Package.OutfitPackage", null)
                        .WithMany("Layers")
                        .HasForeignKey("OutfitPackageId");
                });

            modelBuilder.Entity("minerobe.api.Entity.Package.OutfitPackage", b =>
                {
                    b.HasOne("minerobe.api.Entity.MinerobeUser", "Publisher")
                        .WithMany()
